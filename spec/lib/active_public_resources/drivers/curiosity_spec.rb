...
describe APR::Drivers::Curiosity do

  let(:driver) { APR::Drivers::Curiosity.new }
  ...
  describe "#perform_request" do
    ...
    it "should get folder: science/mcat/society-and-culture/social-structures", :vcr, :record => :none do
      ...
      rt_url.driver.should eq(APR::Drivers::Curiosity::DRIVER_NAME)
      ...
      rt_iframe.driver.should eq(APR::Drivers::Curiosity::DRIVER_NAME)
      ...
      ex_rt_url.driver.should eq(APR::Drivers::Curiosity::DRIVER_NAME)
